...
| `engine/` | The `washes` npm-shaped package, v1.21.0 — `src/` (core, GPU sim, timeline sidecar, typings, shader), `tests/`, `dist/washes.standalone.js` for classic script tags |
...
- **`engine/CHANGELOG.md`** tracks the engine package (0.98.0 → 1.21.0).
